...
const candidates: Candidate[] = [
  { id: 'CU-01', name: 'Cu-Cr-Zr · 析出强化', family: '高强高导基线', summary: '在成熟 Cu-Cr-Zr 体系上优化 Cr/Zr 比例与双级时效窗口。', strength: 928, conductivity: 48.6, relaxation: 86, cost: '1.08×', novelty: '★★☆', risk: '低', route: '固溶 980°C → 快冷 → 450°C / 2h 时效', color: 'copper' },
  { id: 'CU-02', name: 'Cu-Ni-Si · 复合析出', family: '平衡性能路线', summary: '利用 Ni-Si 析出相与微量 Zr 协同，兼顾导电率和应力松弛。', strength: 914, conductivity: 51.2, relaxation: 91, cost: '1.12×', novelty: '★★★', risk: '中', route: '固溶 930°C → 冷轧 60% → 400°C / 4h 时效', color: 'teal' },
  { id: 'CU-03', name: 'Cu-Cr-Zr + 梯度组织', family: '发散探索路线', summary: '用多级变形构建表层细晶与芯部高导的梯度组织，探索新窗口。', strength: 956, conductivity: 46.8, relaxation: 88, cost: '1.19×', novelty: '★★★★', risk: '中高', route: '固溶 → 多级冷轧 → 短时退火 → 峰值时效', color: 'violet' },
];
    ...
    <main className="app-shell">
      ...
      <div id="top" className="workspace">
        <section className="intro-row" aria-labelledby="page-title">
          <div><p className="eyebrow">COPPER ALLOY / DESIGN LOOP 04</p><h1 id="page-title">从目标性能，反推铜合金成分与工艺。</h1><p className="intro-copy">输入高强、高导、应力松弛与制造边界，快速生成可解释、可验证的铜合金候选方案。</p></div>
        ...
        <div className="workspace-grid">
          <aside className="brief-panel panel" aria-labelledby="brief-heading">
            ...
            <form className="brief-form" onSubmit={handleGenerate}>
              ...
              <div className="constraint-meter"><span><strong>12</strong> 项约束已锁定</span><span className="meter-track"><i /></span></div>
